...
ЛР3:
Скріншоти деяких сторінок у файлі task3. Усі сторінки коректно відображаються на телефоні.
Застосовано: media запити, Flexbox, Html-атрибути валідації форм, селектори з псевдокласами, усі файли css імпортуються в main.css.